...
SETTINGS = {
    ...
    'growth_rate_std': 0.341510064188599,
}
...
def main(replicates: int, initial_n: int, generations: int, fixed_growth_rate: float,
    ...
    data.to_excel(f'experimental_pop_growth_LS12gen20_3_MAX.xlsx', index_label=f'{initial_n} initial cells')
    summary_stats = measure_replicate_stats(replicate_list=replicate_list)
    summary_stats.to_excel(f'experimental_pop_growth_stats_LS12gen20_3_MAX.xlsx', index_label=f'Replicate')
